...
public class BoundingAreaBuilder {
	...
	public static Array<Polygon> getColliders(EngineEntity entity) {
		...
		if (rendererComponent != null) {
			collectColliders(rendererComponent.getRendererActor(), colliders);
		}
		return colliders;
	}

	public static void collectColliders(RendererActor rendererActor,
		...
		for (Actor actor : rendererActor.getChildren()) {
			if (actor instanceof RendererActor) {
				collectColliders((RendererActor) actor, colliders);
			}
		}
	}
